...
def add_icon_to_image(input_folder, output_folder, icon_path, background_image_path,
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith((".png", ".jpg", ".jpeg")):
            ...
            with Image.open(io.BytesIO(output_data)) as img:
                ...
                crop_left = int(img.width * crop_left_percentage)
                ...
                new_icon_width = int(crop_img.width * icon_size_percentage)
                new_icon_height = int(crop_img.height * icon_size_percentage)

                # Calculate the top-left coordinates of the icon
                margin_left = int(crop_img.width * margin_percentage)
                margin_top = int(crop_img.height * margin_top_percentage)
...
# Specify the input folder, output folder, SVG icon path, and background image path
input_folder_path = "input_folder"
output_folder_path = "output_folder"
svg_icon_path = "logo1.svg"
background_image_path = "background.png"

# Call the add_icon_to_image function with crop_left_percentage set to 0.5 (adjust as needed)
add_icon_to_image(input_folder_path, output_folder_path, svg_icon_path, background_image_path, crop_left_percentage=0.35)
